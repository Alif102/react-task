    ...
    return (
      <div>
          <div>
                ...
                <div className='w-[100%] h-auto pb-5 mb-5 mx-auto px-3 space-y-4 bg-[#D9D9D9] relative mt-7 pt-8  flex flex-col justify-center items-center gap-2'>
                <div className="bg-[#BDBDBD] h-[50px] w-[100%] top-0 absolute mb-5 flex justify-center items-center text-center">{title}</div>
                 
                  <div className='flex gap-2 pt-7'>
                    <div className='h-[55px] w-[40%] bg-white '>
