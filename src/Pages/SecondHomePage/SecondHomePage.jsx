    ...
    <div className='container mx-auto'>
      <div className='grid md:grid-cols-12 md:mx-10 mx-2 gap-6 lg:grid-cols-12 grid-cols-1'>
        ...
        <div className='col-span-10'>
          ...
          <div className='grid md:grid-cols-8 grid-cols-1  gap-2'>
            ...
            <div className='md:col-span-5'>
              ...
              <p className='text-[14px] w-[100%] '>
                ...
                ‘তারা জানে তাদের কেউ নিতে আসবে না। তারা সারাবছর কাঁদে না। কিন্তু যখন সহপাঠীদের সবাই বাসায় নিয়ে যায় অথচ তাদের কেউ নিতে আসে না তখন তাদের দুঃখ শুরু হয়ে যায়। মৃত মা-বাবার ওপর তাদের অভিমান সৃষ্টি হয়- কেন তারা তাদের দুনিয়ায় রেখে এই বয়সে মারা গেলেন? তারা কি আর কিছুটা দিন বেঁচে থাকতে পারতেন না? মা বাবা বেঁচে নাই তো কী হইছে? মামা চাচারা কেউ তাদেরকে নিতে আসল না কেন? মা বেঁচে থাকতে মামারা কত আদর করত! বাবা বেঁচে থাকতে চাচারা কত আদর করত! এই বয়সেই তারা দুনিয়ার একটা নিষ্ঠুর চেহারা দেখেছে।
